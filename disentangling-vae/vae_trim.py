...
def parse_arguments():
    ...
    ##### TRIM Options #####
    trim = parser.add_argument_group('TRIM specfic options') 
    trim.add_argument('--trim-method',
                      default=default_config['trim_method'], 
                      help="Type of TRIM attr method to use.")
    trim.add_argument('--trim-lamb', type=float,
                      default=default_config['trim_lamb'],
                      help="Parameter of the TRIM score.")  
    
    ##### Attribution Options #####
    attr = parser.add_argument_group('Attribution specfic options') 
    attr.add_argument('--attr-lamb', type=float,
                      default=default_config['attr_lamb'], 
                      help="Parameter of the attribution.")
...
def main(args, classifier=None):
    ...
    if not args.is_eval_only:
        ...
        trainer = Trainer(model, optimizer, loss_f,
                          ...
                          trim_lamb=args.trim_lamb,
                          attr_lamb=args.attr_lamb)
