...
sys.path.append('../../')
sys.path.append('../../../')
from src.vae.utils.math import matrix_log_density_gaussian, log_density_gaussian, log_importance_weight_matrix, logsumexp
from src.vae.models.loss_hessian import hessian_penalty
